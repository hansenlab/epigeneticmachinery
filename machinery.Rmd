...
df_web <- data.frame(gnomAD = sprintf('<a href="https://gnomad.broadinstitute.org/gene/%s">%s</a>', web$Ensembl_id, web$Ensembl_id),
                     OMIM = sprintf('<a href="https://www.omim.org/entry/%s">%s</a>', web$mim_number, web$mim_number),
